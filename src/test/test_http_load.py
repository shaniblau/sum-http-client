...
def test_execute(http_load_fixture, mock_requests, mocker):
    ...
    mock_create_files = mocker.patch('load.http_load.HTTPLoad.__create_files', return_value=files)
    mock_load_files = mocker.patch('load.http_load.HTTPLoad.__load_files', return_value=requests.Response)
    mock_log_response = mocker.patch('load.http_load.HTTPLoad.__log_response')
    mock_delete_files = mocker.patch('load.http_load.HTTPLoad.__delete_files')
