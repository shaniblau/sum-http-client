...
def test_load_first_half_should_return_1_and_call_expire(redis_fixture, redis_client_fixture):
    expected = 1
...
def test_load_second_half_should_return_0_and_not_call_expire(redis_fixture, redis_client_fixture):
    expected = 0
